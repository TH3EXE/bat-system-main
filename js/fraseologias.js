...
window.FRASEOLOGIAS_DATA = {
    ...
    "negativas": [
        ...
        {
            id: '19',
            nome: '19 -> 25 – HOMECARE OU DOMICILIAR (EXCLUSÃO DE COBERTURA - SEM SERVIÇO ESPECIALIZADO)',
            template: "PREZADO(A) SR(A). [_NM_BENEFICIARIO_]\nNÚMERO DO PROTOCOLO: [_NU_PROTOCOLO_]\n\nA atuação da Operadora Hapvida está vinculada à regulação do Governo Federal, através da Agência Nacional de Saúde Suplementar - ANS, Autarquia Federal reguladora do referido setor de saúde. As coberturas são estabelecidas pela ANS, conforme previsto no Rol de Procedimentos e Eventos em Saúde, e determinadas pela Resolução Normativa n°. 465/2021, sob o amparo da Lei Federal n°. 9656/98. Após análise da solicitação de Home Care, verificou-se que o referido serviço não é de cobertura obrigatória pelas operadoras de planos de saúde, conforme os termos da Lei e Resolução acima mencionadas, bem como do instrumento contratual firmado entre as partes. Cumpre salientar, ainda, que em PARECER TÉCNICO Nº 05/GEAS/GGRAS/DIPRO/2019, a Agência Nacional de Saúde Suplementar - ANS corroborou que a Lei nº 9.656/1998, não inclui a Atenção Domiciliar entre as coberturas obrigatórias. No mesmo sentido, a RN nº 465/2021 também não prevê cobertura obrigatória para quaisquer procedimentos executados em domicílio. Dessa forma, o pedido para autorização do serviço de home care, não foi aprovado, por não se enquadrar em condições de cobertura obrigatória, visto inexistir previsão legal e contratual para tanto.\n\nEM CASO DE DÚVIDAS, POR FAVOR, ENTRE EM CONTATO COM A CENTRAL DE ATENDIMENTO PELOS TELEFONES: 4090-1740, 0800 409 1740 OU 0800 463 4648."
        },
        {
            id: '24',
