...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const searchInput = document.getElementById('terapias-search-input');
    const noResultsMsg = document.getElementById('terapias-no-results');
    ...
    // Roda o filtro uma vez no início para garantir
    filtrarTabelasAtivas();
});